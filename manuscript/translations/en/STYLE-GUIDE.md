# English edition style and terminology guide

The Korean chapters in `manuscript/chapters/` are canonical. The English edition should read as original English-language wuxia/progression fantasy while preserving every event, limitation, relationship, and ambiguity.
...
Use Revised Romanization-like spellings consistently, without hyphens in given names:

- 진철 — Jin Cheol
- 한연화 / 연화 — Han Yeonhwa / Yeonhwa
- 서무한 — Seo Muhan
- 위소현 — Wi Sohyeon
- 남궁태 — Namgung Tae
- 도창수 — Do Changsu
...
- 청계촌 — Cheonggye Village
- 물레골 — Mulle Valley
- 흑풍산 — Blackwind Mountain
- 망념서고 — Archive of Forsaken Obsessions
- 무림 — murim (lowercase as a social order; “the murim world” where natural)
- 무림맹 — Murim Alliance
- 운문표국 — Unmun Escort Agency
- 청하표국 — Cheongha Escort Agency
- 청우관 — Cheongu Hall
- 화산 — Mount Hua / the Mount Hua sect according to context
- 남궁세가 — Namgung Clan

## Martial and metaphysical terms

Use these exact English forms on first and later occurrence:

- 단전 — dantian
- 내공 — internal energy
- 자연기 — ambient qi
- 운기 — qi circulation / circulate qi, according to grammar
- 기파 — qi wave
- 경지 — realm or stage
- 삼류 / 이류 / 일류 — third-rate / second-rate / first-rate
- 절정 / 초절정 — peak / transcendent realm
- 폐공 — cultivation severance; “sever one’s cultivation” as a verb
- 해리심경 — Sutra of Unraveling
- 해기 — Unraveling Qi
- 심안 — Mind’s Eye
- 이형신법 — Form-Shifting Art
- 유영보 — Drifting Step
- 감지 / 분석 / 간섭 / 종합 / 해체 — Perception / Analysis / Interference / Synthesis / Dissolution
- 공명구 — resonance implement
- 비무 — martial contest or duel, depending on stakes
- 입문 의식 — initiation rite
- 주화입마 — qi deviation, if it appears

Introduce Korean-derived terms through context rather than parenthetical glossary dumps.

## Titles

- 검성 — Sword Saint
- 도왕 — Saber King
- 사부 — master only where a master-disciple relationship genuinely exists
- 형 / 아우 and status address — translate according to relationship and tone; do not mechanically retain honorifics.

## Formatting

Each file must begin exactly:

`# Chapter N. <Title>`

Then publishable English prose only. Preserve scene breaks as `***`. Do not include translator notes, summaries, glossaries, or commentary in chapter files.

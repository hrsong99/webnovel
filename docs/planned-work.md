...
## 2. Source-language generalization in the generator
...
## 3. Retired-story assets in the working tree
...
## 4. Split `murim-abolitionist`'s continuity ledger out of the story bible
